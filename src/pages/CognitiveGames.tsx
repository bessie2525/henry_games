  ...
  return (
    <main className="min-h-screen px-4 py-6 md:py-8">
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <section className="relative overflow-hidden rounded-[44px] px-6 py-12 md:px-10 md:py-16">
        ...
        <section id="games" className="rounded-[34px] bg-slate-100/70 p-3 sm:p-5">
